          ...
          <div class="p-6">
            ...
            <div class="space-y-4">
              <div>
                ...
                <input type="text" value="http://localhost:11434" class="w-full bg-surface-container-highest border border-outline-variant/50 rounded-lg px-4 py-3 text-sm text-neutral-100 focus:outline-none focus:border-primary-fixed-dim focus:ring-1 focus:ring-primary-fixed-dim transition-colors" placeholder="e.g. http://localhost:11434" />
              </div>
              ...
              <div class="pt-2">
                <button class="bg-primary-fixed-dim text-on-primary-fixed font-bold py-2 px-6 rounded-full text-sm hover:brightness-110 transition-all shadow-md">
                  Save AI Settings
                </button>
              </div>
            </div>
